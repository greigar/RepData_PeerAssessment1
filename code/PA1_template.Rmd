...
Note that ggplot's `geom_bar()` is used here and not `geom_histogram()`.  See [RStudio blog on ggplot](https://blog.rstudio.org/2015/12/21/ggplot2-2-0-0/).
...
ggplot(activity_filled_by_day,  aes(x = date, y = step_mean)) +
    ...
    labs(x = "Date of Measurement", y = "Average Number of Steps") +        # set label text
    ggtitle("Average Number of Steps per Day with filled in missing days")  # set title
```
